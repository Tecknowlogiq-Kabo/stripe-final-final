...
export class TrustRepository {
  ...
  async insert(
    ...
    await this.dataSource.query(
      `INSERT INTO TRUST_TOKENS (ID, TOKEN_HASH, RESOURCE_TYPE, RESOURCE_ID, STATUS, EXPIRES_AT, CREATED_BY, METADATA, CREATED_AT, UPDATED_AT)
       VALUES (:1, :2, :3, :4, :5, :6, :7, :8, SYSDATE, SYSDATE)`,
      [id, tokenHash, resourceType, resourceId ?? null, 'pending', expiresAt, createdBy ?? null, metadata ?? null],
    );
  }
